 ...
 * @author canssm
 */
public class DatacenterBrokerCan extends SimEntity {
	 ...
	 * @post $none
	 */
	public DatacenterBrokerCan(String name) throws Exception {
		super(name);
	 ...
	 * @post $none
         ...
         *
         * The method {@link #submitVmList(List)} may have
         * be checked too.
	 */
	...
	protected void processCloudletReturn(SimEvent ev) {
		...
		Log.printConcatLine(CloudSim.clock(), ": ", getName(), ": Cloudlet ", cloudlet.getCloudletId(),
				" received");
		cloudletsSubmitted--;
		if (getCloudletList().size() == 0 && cloudletsSubmitted == 0 && allVMsNotInMigration()) { // all cloudlets executed and all vms not in migration
			Log.printConcatLine(CloudSim.clock(), ": ", getName(), ": All Cloudlets executed. Finishing...");
			clearDatacenters();
			finishExecution();
		} else { // some cloudlets haven't finished yet
			if (getCloudletList().size() > 0 && cloudletsSubmitted == 0 && allVMsNotInMigration()) {
