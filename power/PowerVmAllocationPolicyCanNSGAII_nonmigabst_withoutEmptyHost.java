 ...
 * @author canssm
 */
public class PowerVmAllocationPolicyCanNSGAII_nonmigabst_withoutEmptyHost extends PowerVmAllocationPolicyAbstract {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyCanNSGAII_nonmigabst_withoutEmptyHost(List<? extends Host> list) {
		super(list);
