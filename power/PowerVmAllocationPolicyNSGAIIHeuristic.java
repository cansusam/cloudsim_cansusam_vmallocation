 ...
 * @author canssm
 */
public class PowerVmAllocationPolicyNSGAIIHeuristic extends PowerVmAllocationPolicyAbstractExtended {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyNSGAIIHeuristic(List<? extends Host> list) {
		super(list);
...
////						double vmHostTotalMips = vmListWithoutNullHosts.get(antSelectedVm[l]).getTotalUtilizationOfCpuMips(CloudSim.clock());
